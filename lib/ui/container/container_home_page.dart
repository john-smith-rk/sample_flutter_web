...
class ContainerHomePage extends StatelessWidget{
  ...
  ContainerHomePage({Key? key}) : super(key: key);
  ...
  final List<String> featureList = [
    ...
    "Tank Order Register",
    "Optimization Logic for Putaway and Allocation Rules",
    "Receipt/Storing order",
    "Equipment Interchange Receipt (EIR) generation",
    "Bill of Lading",
    "EOR and MNR",
    "Gate in/Gate Out",
    "Billing",
    ...
    return  SingleChildScrollView(
      child: Column(
        ...
        children: [
          ...
          const HeaderTitlePage("Container Management System"),
  ...
  Widget buildTitleView(BuildContext context) {
    return  Container(
      ...
      child: Column(
        ...
        children: [
          Text(
            "Overview Of Your Container Assets",
            style: Theme.of(context).textTheme.displaySmall?.copyWith(color: Colors.indigo.shade900, fontWeight: FontWeight.bold ),
          ),
          const SizedBox(height: 10,),
          Text( "KEYfields’ iCMS allows container owners visibility and management of their container assets. With extensive features allowing real time tracking of container inventories internally & externally from the depot and location. Service charges such as repair and billing, demurrage charges and other shipping charges allow container owners to better track and improve billing speed and accuracy.",
  ...
  Widget builtWMSFeatureImageView(BuildContext context) {
    return Container(
      ...
      width: MediaQuery
          ...
          .size
          .width,
      child: Image.asset("assets/images/iCMS.png", fit: BoxFit.cover,),
    );
  }
